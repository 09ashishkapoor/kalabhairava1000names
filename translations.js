/**
 * English UI copy for Kalabhairava Sahasranama.
 */

const translations = {
	en: {
		landing: {
			title1: "Kālabhairava 1000 Names",
			title2: "Sahasranāma",
			subtitle:
				"Kalabhairava 1000 Names — Complete Kālabhairava Sahasranāma with English meanings. Explore the full list of 1000 sacred names, translations, and devotional notes on this page.",
			significance:
				"<strong>Significance:</strong> Chanting the <em>Kalabhairava Sahasranama</em> is believed to remove fear, grant protection from negativity, destroy internal enemies (ego, anger), and bestow spiritual liberation (Moksha).",
			dedication:
		...
		ebook: {
			...
			description:
				"Download free PDF ebooks containing the <strong>1000 sacred names of Kālabhairava</strong> and their meanings. Same content as this website, now portable!",
			linkText: "Visit jaikhyapaparampara.com",
		},
		names: {
			title: "Read, Search, and Sit with Each Name",
			subtitle:
				"Move through the names at your own pace, search by word or meaning, and open any entry for a fuller explanation.",
			...
			statsDisplay:
				"📿 Displaying the sacred <strong>{total}</strong> names of <strong>Śrī Kālabhairava</strong>",
			statsSearch:
				'🔍 Found <strong>{count}</strong> name{plural} matching "<strong>{query}</strong>" out of <strong>{total}</strong> total names',
			searchLoading:
				"Search is loading the remaining names. Results will appear shortly.",
		},
		footer: {
			developer: "Website developed by <strong>Kaliputra Ashish</strong>",
			dedication:
				"Dedicated to <strong>Shri Praveen Radhakrishnan</strong> and <strong>Khyapa Parampara</strong>",
